    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input1, file$b, 62, 10, 1314);
    			add_location(label, file$b, 61, 8, 1260);
    			set_style(p, "display", "none");
    			add_location(p, file$b, 60, 6, 1226);
    			...
    			add_location(input3, file$b, 65, 6, 1413);
    			attr_dev(textarea, "name", "Message");
    			attr_dev(textarea, "placeholder", "Message");
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "svelte-1o1fjbm");
    			add_location(textarea, file$b, 66, 6, 1462);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "svelte-1o1fjbm");
    			add_location(button, file$b, 67, 6, 1528);
